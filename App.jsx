...
const App = () => {
  ...
  const [myName, setMyName] = useState('Ajit')
  ...
  //   ...prev, //spread operator & rest operator
  //   gender:'male'
  // }))
  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'white', marginTop: 50 }}>
     ...
     source={{uri : 'data:image/png;base64,'}}/> */}
      ...
      <Text style={{fontSize:30, alignSelf:'center'}}>Hooks : {myName}</Text>
      <Text style={{fontSize:30, alignSelf:'center'}}>count : {count}</Text>

      <Button title={'Update'} onPress={() => {onUpdate()}}/> */}

      {/* <Child1 name={name} age={age} gender={gender}/> */}
  ...
  <Button title='Click Me'/>
      ...
      <View style={[styles.boxStyle, {backgroundColor:'yellow', }]}>
      <Text>C</Text>
      </View>
      <View style={styles.boxStyle}>
      <Text>D</Text>
